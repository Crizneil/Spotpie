...
Manages setup of the `criz-spotpie` executable in ~/.local/bin or /usr/local/bin,
PATH validation, and clean uninstallation.
"""
...
def get_install_target_dir(system_wide: bool = False) -> Path:
...
def create_launcher_script(
    ...
    """
    Create a standalone bash wrapper script in target_dir that invokes main.py
